...
* VrApi’s framebuffer capture now only streams buffered layers to prevent Oculus Remote Monitor from streaming a single cursor layer.
...
* SMS now displays sender’s phone number.
...
* User’s real name now displayed on profile page.
Bug Fixes
