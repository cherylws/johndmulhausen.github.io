...
ETW is included in the Windows Driver Kit 8.1: [https://developer.microsoft.com/en-us/windows/hardware/windows-driver-kit](https://developer.microsoft.com/en-us/windows/hardware/windows-driver-kit).
...
` &lt;SDK Folder&gt;\Samples\OculusRoomTiny_Advanced\ORT (Buffered Haptics)\Projects\Win\VS2013`

**1. Run the Oculus application, and assure that your Rift is set up and working properly.**

**2. Open the following **<u>solution</u>** (not the project) in Visual Studio 2015:**



![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-0.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-1.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-2.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-3.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-4.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-5.png)



**4. Launch the application binary, which is located here:**

`Oculus_SDK&gt;\Samples\OculusRoomTiny_Advanced\ORT (Buffered Haptics)\Bin\Windows\Win32\Debug\VS2013\z.Buffered Haptics.exe`

**5. In the headset, you should now see the Oculus Performance HUD:**



![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-6.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-7.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-8.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-9.jpg)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-10.jpg)
...
**6. Take off the headset, and click the <strong>Stop** button in the Lost Frame Capture tool window.</strong>

**7. Optionally, click <strong>Save** to save the captured data to an Oculus Debug Archive (ODA) file. Name it appropriately, for example `app_1000.oda` (if the loop variable in the shader routine was set to 1000).</strong>

**You can now see the lost frames, and even step through them by moving the cursor up and down the list of frames:**



![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-11.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-12.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-13.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-14.png)



**3. Select <strong>File &gt; Open**, and open the `merged.etl` file that was produced above:</strong>
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-15.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-16.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-17.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-18.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-19.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-20.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-21.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-22.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-23.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-24.png)



**11. Drag down the bottom of the chart, in order to enlarge the view:**

![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-25.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-26.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-27.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-28.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-29.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-30.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-31.png)



**4. We only want to show the z.Buffered Haptics.exe process. So, right click on that process and select <strong>Hide/Show Process**:</strong>



![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-32.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-33.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-34.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-35.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-36.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-37.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-38.png)
...
![](/images/documentationpcsdklatestconceptsdg-performance-tutorial-39.png)
...
ovrlog_win10 and ovrlog generate traces that include NVIDIA or AMD vsync events, depending on the hardware that your system is using. In order to display vsyncs within GPUView, you must run the following batch file <u>before</u> generating the ETW trace:
