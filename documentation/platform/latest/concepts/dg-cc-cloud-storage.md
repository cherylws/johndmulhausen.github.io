...
Cloud Storage is designed to support the following use-cases in Rift apps:
...
```
[OnlineSubsystem]
DefaultUserCloudBucket=&lt;YOURBUCKETNAME&gt;
```

Where `&lt;YOURBUCKETNAME&gt;` is the bucket name that you defined on the Dashboard.
